    ...
    <>
      <div className="introduction">
        <span className="intro-groups">
          ...
          <p>
            Transform your travel dreams into reality. Start your next adventure
            with TripMosaic today!
          </p>
      ...
      <div className="about-us">
        ...
        <span>
          ...
          <p>
            At TripMosaic, we believe that planning a trip should be as exciting
            as the journey itself. We’re here to simplify the process, making it
            easy, fun, and visually stunning to organize every detail of your
            adventure. Whether you’re a solo traveler, a family on vacation, or
            a group of friends exploring the world, TripMosaic helps you craft
            the perfect itinerary, so you can focus on making memories instead
        ...
        <span>
          ...
          <p>
            ...
            single, beautiful platform where your entire journey comes together.
          </p>
        </span>
      ...
      <div className="join">
        ...
        <span>
          ...
          <p>
            ...
            seamless, enjoyable, and stress-free. From quick weekend getaways to
            epic global adventures, we’re here to help you create the perfect
            travel experience.
          </p>
        </span>
        ...
        <span>
          ...
          <ul>
            <li>
              All-in-One Planning: Streamline your travel plans with beautifully
        ...
        <span>
          ...
          <ol>
            ...
            <li>
              Share and Collaborate: Invite travel companions to join your plan
              and contribute.
            </li>
          </ol>
        </span>
